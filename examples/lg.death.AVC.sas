...
* Decile Analysis of AGE                                                       ;
  %LOGIT(VAR=AGE, EVENT=DEAD, GROUPS=5, IN=AVCS);
...
* Decile Analysis of STATUS                                                    ;
  %LOGITGR(VAR=STATUS, EVENT=DEAD, GROUPS=STATUS, IN=AVCS);
...
* Decile Analysis of INC_SURG                                                  ;
  %LOGIT(VAR=INC_SURG, EVENT=DEAD, IN=AVCS);
...
* Decile Analysis of OPMOS                                                     ;
  %LOGIT(VAR=OPMOS, EVENT=DEAD, GROUPS=4, IN=AVCS);
