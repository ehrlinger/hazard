...
* Bring in data                                                                ;
  ...
  TITLE3 "Death Beyond 30 Days After Repair";
...
*                                                                              ;
  ...
  ;
  IF INT_DEAD LE 12*30/365.2425 THEN DELETE;
*******************************************************************************;
...
* Decile Analysis of AGE                                                       ;
  %LOGIT(VAR=AGE, EVENT=DEAD, GROUPS=5, IN=AVCS, INTERVAL=INT_DEAD, COX=1);
...
* Decile Analysis of STATUS                                                    ;
  %LOGITGR(VAR=STATUS, EVENT=DEAD, GROUPS=STATUS, IN=AVCS, INTERVAL=INT_DEAD, COX=1);
...
* Decile Analysis of INC_SURG                                                  ;
  %LOGIT(VAR=INC_SURG, EVENT=DEAD, IN=AVCS, INTERVAL=INT_DEAD, COX=1);
...
* Decile Analysis of OPMOS                                                     ;
  %LOGIT(VAR=OPMOS, EVENT=DEAD, GROUPS=4, IN=AVCS, INTERVAL=INT_DEAD, COX=1);
